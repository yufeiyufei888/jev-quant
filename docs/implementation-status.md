...
- Synthetic integration: two-session Mock decision → delayed order arrival → interval-open fill → T+1 → cash/NAV; 65 tests pass. All baseline account examples are synthetic engineering evidence only.
