...
- Synthetic integration: two-session Mock decision → delayed order arrival → interval-open fill → T+1 → cash/NAV; 54 tests pass. This remains synthetic engineering evidence only.
